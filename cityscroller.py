...
class Scroller(object):
    ...
    def add_building(self, x_location):
        building_width = random.randint(self.width//20, (self.width//4)) #Floor division. Divides and then rounds down.
        max_height = self.base - self.height
        building_height = random.randint(max_height // 20, (max_height // 4))
